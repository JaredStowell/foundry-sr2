...
describe("createItemMacro", () => {
    ...
    it("warns when dropped item cannot be resolved or has no actor", async () => {
        ...
        expect(ui.notifications.warn).toHaveBeenCalledWith("This item must be owned by an actor to create a macro");
    });
...
describe("hotbar drop and executeSR2Macro", () => {
    ...
    it("shows errors for missing actor/item in executeSR2Macro", async () => {
        ...
        window.executeSR2Macro("a", "i", "attack");
    ...
    it("routes actions through actor sheet handlers and fallback rolls", async () => {
        ...
        window.executeSR2Macro("actor-1", "weapon-1", "attack");
        window.executeSR2Macro("actor-1", "skill-1", "concentration");
        window.executeSR2Macro("actor-1", "gear-1", "use");
    ...
    it("handles spell and skill fallback/specialization execution paths", async () => {
        ...
        window.executeSR2Macro("a", "spell-1", "cast");
        window.executeSR2Macro("a", "skill-1", "specialization");
        ...
        window.executeSR2Macro("a", "spell-2", "cast");
        window.executeSR2Macro("a", "skill-2", "base");
    ...
    it("falls back to weapon roll when attack handler is unavailable", async () => {
        ...
        window.executeSR2Macro("actor", "w1", "attack");
